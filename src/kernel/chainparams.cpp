...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 709632; // Approximately November 12th, 2021
                                                                                              //
        // Deployment of CTV (BIP-119), CAT (BIP-347), CSFS (BIP-348), IPK (BIP-349)
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COVOPS].min_activation_height = 907'876; // Approximately August 1st, 2025
