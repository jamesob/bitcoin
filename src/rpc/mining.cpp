...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    ...
    // Use the validated chainstate since we don't want to assemble blocks on
    // the basis of an unvalidated chain.
    if (g_chainman.ValidatedChainstate()->IsInitialBlockDownload())
