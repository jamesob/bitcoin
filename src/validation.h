...
private:
     ...
     */
    std::unique_ptr<CChainState> m_unready_snapshot_chainstate GUARDED_BY(cs);

    /**
     * If not empty, this points to metadata corresponding to the UTXO snapshot
     * currently in use.
     */
    std::unique_ptr<SnapshotMetadata> m_snapshot_metadata GUARDED_BY(cs);
     ...
     */
    std::unique_ptr<CChainState> m_ibd_chainstate GUARDED_BY(cs);

    /**
     * A chainstate initialized on the basis of a UTXO snapshot. If this is
     * truthy, it is always our active chainstate unless proven invalid.
     */
    std::unique_ptr<CChainState> m_snapshot_chainstate GUARDED_BY(cs);
...
public:
     ...
     * most-work chain.
     */
    CChainState* m_active_chainstate GUARDED_BY(cs);
