...
{
    // Good example
    DataStream ss1{HexLiteral("97f23c835800816115944e077fe7c803cfa57f29b36bf87c1d35")};
    Coin cc1;
    ss1 >> cc1;
    BOOST_CHECK_EQUAL(cc1.fCoinBase, false);
    BOOST_CHECK_EQUAL(cc1.nHeight, 203998U);
    BOOST_CHECK_EQUAL(cc1.out.nValue, CAmount{60000000000});
    BOOST_CHECK_EQUAL(HexStr(cc1.out.scriptPubKey), HexStr(GetScriptForDestination(PKHash(uint160(HexLiteral("816115944e077fe7c803cfa57f29b36bf87c1d35"))))));

    // Good example
    DataStream ss2{HexLiteral("8ddf77bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4")};
    Coin cc2;
    ss2 >> cc2;
    BOOST_CHECK_EQUAL(cc2.fCoinBase, true);
    BOOST_CHECK_EQUAL(cc2.nHeight, 120891U);
    BOOST_CHECK_EQUAL(cc2.out.nValue, 110397);
    BOOST_CHECK_EQUAL(HexStr(cc2.out.scriptPubKey), HexStr(GetScriptForDestination(PKHash(uint160(HexLiteral("8c988f1a4a4de2161e0f50aac7f17e7f9555caa4"))))));

    // Smallest possible example
    DataStream ss3{HexLiteral("000006")};
    Coin cc3;
    ss3 >> cc3;
    ...
    DataStream ss4{HexLiteral("000007")};
    try {
        Coin cc4;
        ss4 >> cc4;
    ...
    DataStream ss5{HexLiteral("00008a95c0bb00")};
    try {
        Coin cc5;
        ss5 >> cc5;
        BOOST_CHECK_MESSAGE(false, "We should have thrown");
