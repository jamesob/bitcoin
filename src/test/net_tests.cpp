...
BOOST_AUTO_TEST_CASE(cnetaddr_unserialize_v2)
{
    ...
    // Valid IPv4.
    s << HexLiteral("01"         // network type (IPv4)
                      "04"         // address length
                      "01020304"); // address
    s >> ser_params(addr);
    ...
    // Valid IPv6.
    s << HexLiteral("02"                                 // network type (IPv6)
                      "10"                                 // address length
    ...
    // TORv2, no longer supported.
    s << HexLiteral("03"                     // network type (TORv2)
                      "0a"                     // address length
    ...
    // Valid TORv3.
    s << HexLiteral("04"                               // network type (TORv3)
                      "20"                               // address length
    ...
    // Valid I2P.
    s << HexLiteral("05"                               // network type (I2P)
                      "20"                               // address length
    ...
    // Valid CJDNS.
    s << HexLiteral("06"                               // network type (CJDNS)
                      "10"                               // address length
    ...
    s << HexLiteral("aa"             // network type (unknown)
