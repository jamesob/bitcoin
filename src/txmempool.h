...
public:
     ...
     *    `g_chainman.ActiveCoinsCache()`) and is fully populated. Fully
     *    populated means that if the current active chain is missing transactions
     *    that were present in a previously active chain, all the missing transactions
     *    will have been re-added to the mempool and should be present if they meet
