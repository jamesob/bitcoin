...
bool MemPoolAccept::PolicyScriptChecks(const ATMPArgs& args, Workspace& ws)
{
    ...
    const bool vault_active = DeploymentActiveAfter(m_active_chainstate.m_chain.Tip(), m_active_chainstate.m_chainman, Consensus::DEPLOYMENT_VAULT);
    const unsigned int scriptVerifyFlags = STANDARD_SCRIPT_VERIFY_FLAGS
        ...
        | (vault_active ? SCRIPT_VERIFY_NONE : SCRIPT_VERIFY_DISCOURAGE_VAULT);
