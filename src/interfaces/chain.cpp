...
public:
    ...
    {
        m_notifications->BlockConnected(chainstate, *block, tx_conflicted);
    }
    void BlockDisconnected(const CChainState* chainstate,
        const std::shared_ptr<const CBlock>& block) override
    {
        m_notifications->BlockDisconnected(chainstate, *block);
    }
    void ChainStateFlushed(const CChainState* chainstate, const CBlockLocator& locator) override
    {
        m_notifications->ChainStateFlushed(chainstate, locator);
    }
